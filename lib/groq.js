...
/**
 * Calls Groq, validates the result, and if validation fails,
 * retries ONCE with a stricter follow-up instruction before giving up.
 * This is what "handling bad AI output" looks like at the source,
